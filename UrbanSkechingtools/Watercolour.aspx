<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Watercolour.aspx.cs" Inherits="UrbanSkechingtools.Watercolour" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
      <link href="css/stylesheet4.css" rel="stylesheet" id="style">
...
<body>
    ...
    <nav>
        ...
        <li style="float:center"><a href="index.aspx" font face="Times new roman" font color="white" style="font-size:150%; "  > <b>  Home  </a><li>
            ...
            <li><a class="active" href="Watercolour.aspx" style="font-size:150%; "> Watercolour </a><li>
        ...
        <div class="xyz">
                <div class="hig">
                    <div class="box">
                         <img src="Watercolour/WC1.jpg" alt="">
                     </div>
                     <p>MK1 - Copic</p><br />
                ...
                <div class="hig">
                     <div class="box">
                             ...
                             <img src="Watercolour/WC2.jpg" alt="">
                ...
                <div class="hig">
                 <div class="box">
                 <img src="Watercolour/WC3.jpg" alt="">
                 </div>
                ...
                <div class="hig">
                 <div class="box">
                 <img src="Watercolour/WC4.jpg" alt="">
                 </div>
                 <p>MK4 - STA 48</p>
                 <br />
                 <div style="margin-left:100px;">
                ...
                <div class="hig">
                 <div class="box">
                 <img src="Watercolour/WC5.jpg" alt="">
                 </div>
                 <p>MK5 - Tombow</p>
                 <br />
                 <div style="margin-left:100px;">
